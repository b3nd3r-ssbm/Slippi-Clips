...
function init() {
    ...
    if (store.get('fileSaved') != undefined && store.get('fileSaved') != "") {
        ...
        document
            ...
            .innerHTML = store.get('fileSaved');
        document
            .getElementById("fileWrite")
            .hidden = false;
        document
            .getElementById("firstGen")
            .hidden = true;
...
function generate() {
    ...
    document
        .getElementById('fileName')
        .innerHTML = "Wrote File " + file
        .name
        .substring(0, file.name.length - 2) + "clp";
    document
        .getElementById("fileWrite")
        .hidden = false;
    document
...
function genJson() {
    ...
    document
        .getElementById('fileName')
        .innerHTML = "Wrote " + clippi.queue.length + " files";
    document
        .getElementById("fileWrite")
        .hidden = false;
    document
